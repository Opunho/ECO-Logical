...
5.times do
  @recommendation = Recommendation.create!(
    ...
    title: ["Buy greener", "Its greener to be!","Save the Earth", "We love it", "Why should be green","Dress to impres greener"].sample,
    description: ["We would like to improve your green life by also helping our planet", "Becoming the green person that you always want to be, helping people around you getting more eco-friendly", "Its better to bike and its healty for you and its saving our planet","Green life is also good life, feel more free to help the planet" ].sample,
